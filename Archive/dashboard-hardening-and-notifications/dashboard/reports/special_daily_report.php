...
<header class="cashup-heading"><div><p class="cashup-eyebrow">YOUR WORKSPACE / CASHUPS</p><h1>Manager cashup</h1><p>Review income, sector breakdowns, and staff-related expenses in one place.</p></div></header>
      ...
      <div class="card shadow-sm">
        ...
        <div class="card-header text-dark">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <h4 class="mb-0"><i class="fas fa-file-alt me-2"></i>Manager cashup details</h4>
...
<?= \Portal\Csrf::field() ?><input type="hidden" name="request_key" value="<?= bin2hex(random_bytes(32)) ?>">
