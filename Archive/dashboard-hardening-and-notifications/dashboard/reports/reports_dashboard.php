...
$sql = "SELECT r.*, u.user_scale FROM reports r 
        ...
        WHERE (r.status IS NULL OR r.status != 'archived')";
$params = [];
$types = '';
...
<header class="cashup-heading"><div><p class="cashup-eyebrow">YOUR WORKSPACE / CASHUPS</p><h1>Cashup overview</h1><p>Review income and expense trends for the dates and department you choose.</p></div></header>
