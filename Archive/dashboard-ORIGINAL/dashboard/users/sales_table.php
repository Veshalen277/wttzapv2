            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr class='$rowClass'>
                            ...
                            <td class='text-right'>" . htmlspecialchars(number_format($row['total_income'], 2)) . "</td>
                            <td class='text-right'>" . htmlspecialchars(number_format($row['total_expenses'], 2)) . "</td>
                            <td class='text-right'>" . htmlspecialchars(number_format($row['net_total'], 2)) . "</td>
                            <td>" . htmlspecialchars($row['report_count']) . "</td>
                            <td>" . htmlspecialchars($row['last_report_date'] ? date('Y-m-d', strtotime($row['last_report_date'])) : 'N/A') . "</td>
                          </tr>";
                    $rank++;
                }
                ?>
