...
<div class="container-fluid">
    ...
    if (mysqli_num_rows($result_categories) > 0) {
        while ($category = mysqli_fetch_assoc($result_categories)) {
            ...
            $sql_items = "SELECT item_name, qty_on_hand, order_qty, received_qty FROM fs_stock_items WHERE category_id = $category_id";
            ...
            $data_available = !empty($item_names);
                    ...
                    <?php if ($data_available): ?>
                        ...
                        <script>
                            ...
                            var chart = new Chart(ctx, {
                                ...
                                options: {
                                    responsive: true,
                                    maintainAspectRatio: false, // This line makes sure the chart can grow in height
                                    plugins: {
                                        legend: {
                                            position: 'top',
                                        },
