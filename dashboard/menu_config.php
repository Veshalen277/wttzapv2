    ...
    $menuItems = [
        ...
        2 => [
            ...
            ['title' => 'Stock', 'link' => '#', 'submenu' => [
                ['title' => 'Inventory', 'link' => '/dashboard/inventory/index.php'],
                ['title' => 'Receive / Use / Count', 'link' => '/dashboard/inventory/index.php#movement'],
                ['title' => 'Items & Categories', 'link' => '/dashboard/inventory/index.php#item'],
                ['title' => 'Movement History', 'link' => '/dashboard/inventory/index.php#history'],
                ['title' => 'CSV Import', 'link' => '/dashboard/inventory/index.php#import'],
            ]],
